...
function buildSystemPrompt(workflow, memoryContext, searchContext) {
  ...
  const sections = [
    ...
    '- Preserve and restore momentum',
    '- Appreciate humor and reciprocate it naturally',
    '- Distinguish venting from genuine questions',
    '',
    'WEB SEARCH:',
    'When search results are provided below, use them to answer accurately.',
    'Cite sources naturally -- not as footnotes, but as part of your response.',
    'Example: "According to [source], ..." or "As of [date], ..."',
    'Be clear when information comes from search vs your own knowledge.',
    'If search results are outdated or insufficient, say so.',
    '',
